...
export class News extends Component {
    ...
    async updateNews() {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=417d38add7a74c0bbc957dbb470839ab&page=${this.state.page}&pageSize=${this.props.pageSize}`;
